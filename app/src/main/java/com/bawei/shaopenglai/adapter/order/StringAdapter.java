package com.bawei.shaopenglai.adapter.order;
...
public class StringAdapter extends RecyclerView.Adapter<StringAdapter.ViewHolder> {
    ...
    private List<AlldorInfoBean.OrderListBean> list;
    ...
    public void setData(List<AlldorInfoBean.OrderListBean> datas) {
        list.clear();
        if (datas!=null){
            list.addAll(datas);
        }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view=LayoutInflater.from(context).inflate(R.layout.item_text,
                viewGroup,false);
    ...
    public interface ShopCarListener {
        void callBack(AlldorInfoBean.OrderListBean list);
    }
