...
public class AlldorInfoByStatusAdapter extends RecyclerView.Adapter<AlldorInfoByStatusAdapter.ViewHolder> {
    private List<AlldorInfoBean.OrderListBean.DetailListBean> mList;
    ...
    public void setmList(List<AlldorInfoBean.OrderListBean.DetailListBean> datas) {
        mList.clear();
        if (datas!=null){
            mList.addAll(datas);
        }
    ...
    public List<AlldorInfoBean.OrderListBean.DetailListBean> getmList() {
        return mList;
    }
