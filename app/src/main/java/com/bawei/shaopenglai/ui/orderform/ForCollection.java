...
public class ForCollection extends Fragment implements IView {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter.setShopCarListener(new StringAdapter.ShopCarListener() {
            ...
            public void callBack(AlldorInfoBean.OrderListBean list) {
                ...
                iPresenter.startRequestPut(Apis.URL_CONFIRM_RECEIPT_PUT,map,AddShopping.class);
            }
        });
    }
    ...
    private void loadData() {
        iPresenter.startRequestGet(Apis.URL_FIND_ORDER_LIST_BYSTATUS_GET
                +"?status=2&page=1&count=5",null,AlldorInfoBean.class);
    }
